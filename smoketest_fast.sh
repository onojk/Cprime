#!/usr/bin/env bash
# Robust smoketest: never exits early; aggregates results.
set -u  # (no -e here)
...
# 1) Luby multipliers (1..15) with K=1
check "luby K=1 N=15" \
"1 1 2 1 1 2 4 1 1 2 1 1 2 4 8" \
--rho_iters 1 --rho_restarts 15 --schedule luby

# 2) Luby budgets with K=100 for first 10
check "luby K=100 N=10 budgets" \
"100 100 200 100 100 200 400 100 100 200" \
--rho_iters 100 --rho_restarts 10 --schedule luby

# 3) Doubling with K=10, cap 80 (budgets)
check "doubling K=10 cap=80 N=10" \
